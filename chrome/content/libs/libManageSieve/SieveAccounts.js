    ...
    = function ()
{
    ...
    return "1800000"; //30*60*1000 = 30 Minuten
}
...
/**
 * Sieve depends on IMAP, so every Sieve Account is directly bound to an IMAP
 * account. IMAP accounts are idenfified by the "internal pref key", which is
...
SieveAccount.prototype.getImapKey
 ...
 */
SieveAccount.prototype.getLogin = function( type )
{
...
/*
 * Out of office attribute
 */
SieveAccount.prototype.isEnabledOutOfOffice
    = function ()
{
    if( gPref.prefHasUserValue( this.prefURI + ".enabledOutOfOffice" ) )
        return gPref.getBoolPref( this.prefURI + ".enabledOutOfOffice" );
 ...
 * Out of office attribute
 */
SieveAccount.prototype.setEnabledOutOfOffice = function( enabled )
{
...
/******************************************************************************/
    ...
    /*
     * @param boolean loadAll default false load all the accounts, or only the enabled ones? non-imap accounts are still ignored!
     */
    function SieveAccounts( loadAll )
    {
